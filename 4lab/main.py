...
class LogManager:
    ...
    def add_log(self, raw):
        # Определяем формат и создаем соответствующий объект
        try:
